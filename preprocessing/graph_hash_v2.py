...
chainID_to_cluster_path = '/data/psk6950/PDB_2024Mar18/protein_seq_clust/v2_chainID_to_cluster.pkl'
...
def save_graph_from_cif(cif_path):
    ...
    biomol = BioMol(cif=cif_path, cif_config='./cif_configs/protein_only.json') # 20250303, protein only
    graphs = {}
