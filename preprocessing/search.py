...
def searc_unclassified_fields(field_json, cif_dir, n_sample=10):
    ...
    not_used_fields = fields_classified['not_used'] + fields_classified['crystal_related'] + fields_classified['em_related'] + fields_classified['nmr_related']
        ...
        for field in fields:
            ...
            if field not in classified_fields:
                ...
                if is_unclassified:
                    ...
                    to_test_cif_list.append(cif_file) if cif_file not in to_test_cif_list else None
...
if __name__ == '__main__':
    ...
    condition = {'_pdbx_poly_seq_scheme.pdb_ins_code': (False, '.')} # /public_data/pdb_mmcif/mmcif_files/6ins.cif
