        ...
        for file in files:
            if file.endswith('.a3m.gz'):
                ...
                with env.begin(write=True) as txn:
                    txn.put(a3m_hash.encode(), pickle.dumps(msa_data, protocol=pickle.HIGHEST_PROTOCOL))
                
    env.close()

def mv_signalp(hhblit_result_path = "/data/psk6950/PDB_2024Mar18/new_hash_a3m/",
