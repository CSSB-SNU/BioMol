...
def get_multi_pdb_ID_protein_seqs(
    length_filter=(128, 512), save_path="./statistics/figures/"
):
    """
    ...
    most_frequent_sequences = sorted(
        sequence_to_pdb_num.items(), key=lambda x: x[1], reverse=True
    )[:10]
